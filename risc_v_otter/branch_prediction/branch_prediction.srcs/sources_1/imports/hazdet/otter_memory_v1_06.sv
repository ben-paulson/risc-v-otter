...
//////////////////////////////////////////////////////////////////////////////////
  ...
  module Memory (
    ...
    input [1:0] READ_BYTE_OFFSET, // taken from next stage in pipeline
    input [1:0] READ_MEM_SIZE, // taken from next stage in pipeline
    //output ERR,
    ...
    always_comb begin
        ...
        case({MEM_SIGN,READ_MEM_SIZE,READ_BYTE_OFFSET})
